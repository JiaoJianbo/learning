...
/**
 * @author: Bobby
 * @since 2019/5/7 18:47
 *
 * 因为每次登录成功后，都会询问 Authorize or Deny？这里模拟自动点击 Authorize 并提交，跳过询问的过程
 * 参考 {@link org.springframework.security.oauth2.provider.endpoint.WhitelabelApprovalEndpoint}
 */
@Controller
...
public class SsoApprovalEndpoint {
    ...
    protected String createTemplate(Map<String, Object> model, HttpServletRequest request) {
        ...
        builder.append("<html><body><div style='display:none'><h1>OAuth Approval</h1>"); //添加一个隐藏的DIV
        ...
        builder.append("</div><script>document.getElementById('confirmationForm').submit();</script></body></html>"); //自动提交Authorize的form
